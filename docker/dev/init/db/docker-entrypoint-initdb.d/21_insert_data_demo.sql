...
--		INTEGER	VARCHAR	VARCHAR	DATE	VARCHAR		
	INSERT INTO MYERP.ecriture_comptable (id,journal_code,reference,date,libelle) VALUES (	-1,	'AC',	'AC-2016/00001',	'2016-12-31',	'Cartouches dimprimante'	);
...
--		INTEGER	INTEGER	INTEGER	VARCHAR	NUMERIC(15,2)	NUMERIC(15,2)	
	INSERT INTO MYERP.ligne_ecriture_comptable (ecriture_id,ligne_id,compte_comptable_numero,libelle,debit,credit) VALUES (	-1,	1,	606,	'Cartouches dimprimante',	43.95,	null	);
